...
function Successful() {
    return <div className="flex flex-col flex-grow gap-10 p-10 w-full" >
        <div className="flex flex-col justify-center items-center mt-20 " >
            <div className=" flex flex-col justify-center border-gray-200 border-2 rounded-sm min-w-80 min-h-80 items-center">
                ...
                <Link className="font-bold text-xl pb-10 text-blue-500 underline" href={"/dashboard/p2p"}>Click here to send again</Link>
            </div>
        </div>
    </div>
}