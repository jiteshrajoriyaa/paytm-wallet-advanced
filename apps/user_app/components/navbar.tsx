...
export const Navbar =  ({ user, onSignin, onSignout, image}: NavbarProps) => {
    return (
        <nav className="h-20  flex justify-between pl-20 pr-20 items-center shadow-md">
            ...
            <div className="flex gap-2 items-center" >
                ...
                {user ? <Link href={"/dashboard/profile"} >
                    <img className="w-10 h-10 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500" src={image} alt="Bordered avatar"></img>
                </Link>: ""}
            </div>
